                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @else
                                    <img src="{{asset('dashboard_assets')}}/images/defualt_profile_photo.png" width="20" alt=""/>
                                    @endif

									<div class="header-info">
										<span class="text-black"><strong>  {{ Str::title(auth()->user()->name);}}</strong></span>
										<p class="fs-12 mb-0">SuperAdmin</p>
									</div>
                                </a>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <span class="nav-text">Companie</span>
                        </a>
                        <ul aria-expanded="false">
                            <li>
                                <a class="" href="{{route('companie.index')}}" aria-expanded="false">Companie</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li>
                                <a class="" href="{{route('employee.index')}}" aria-expanded="false">Employee</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{url('userlist')}}" class="ai-icon" aria-expanded="false">
